...
class MouseHandler(object):
    ...
    def _handle_event(self, event, event_name, default_callback):
        ...
        self._mouse_state['modifier'] = event.modifiers()
        self._mouse_state['x'] = event.position().x()
        self._mouse_state['y'] = event.position().y()
    ...
    def wheelEvent(self, event):
        ...
        event : QtEvent
        """
        self._mouse_state['wheel_delta'] = event.angleDelta()
